...
(function($) {
    ...
    $.fn.DualListBox = function(paramOptions, selected) {
        return this.each(function () {
            var defaults = {
                ...
                title:      'Datasets',          // Title of the dual list box.
    ...
    function createDualListBox(options) {
        ...
        $(options.parentElement).addClass('row').append(
                ...
                '       <h4><span class="unselected-title"></span> <small>- showing <span class="unselected-count"></span></small></h4><br>' +
                ...
                (options.horizontal == false ? '   <div class="col-md-5">' : '   <div class="col-md-6">') +
                '       <h4><span class="selected-title"></span> <small>- showing <span class="selected-count"></span></small></h4><br>' +
